...
class bs4_walker_nav_menu extends Walker_Nav_menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ){ // li a span
        ...
        $attributes .= ( $args->walker->has_children ) ? ' class="nav-link dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"' : ' class="nav-link nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger"';
